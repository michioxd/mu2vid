...
fn setup_initial_values(
    ...
    queue_ui.description_text.set_value(&item.description);
...
fn setup_events(
    ...
    let description_text = queue_ui.description_text;
...
fn default_description() -> String {
    "{{timestamp}}\n\nAuto-generated by mu2vid.\nhttps://github.com/michioxd/mu2vid".to_string()
}
